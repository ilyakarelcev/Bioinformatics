**Что Такое ProtT5**  
ProtT5 - это protein language model из проекта **ProtTrans** от Rostlab/TUM. Он основан на архитектуре [[T5]], обучен на [[Белок|белковых]] последовательностях, а не на человеческом тексте.
